      ...
      case "home":
        return (
          <section className="flex flex-col items-center justify-center min-h-screen px-4 pb-24 overflow-hidden">
            ...
            <div className="relative w-full max-w-[240px] -mt-20 sm:-mt-28 fade-up-enter [animation-delay:300ms]">
            ...
            <div className="-mt-20 sm:-mt-28 flex flex-col items-center gap-2 text-center fade-up-enter [animation-delay:600ms]">
